...
window.renderProjects=function(){
  ...
  tb.innerHTML=rows.map(function(p){
    ...
    var revisitCell=showRevisit?('<td style="font-size:11px;color:var(--txt2);line-height:1.6">'+_revBadge+'📅 '+(p.revisit1?fd(p.revisit1):'<span style="color:var(--txt3)">-</span>')+'<br>📅 '+(p.revisit2?fd(p.revisit2):'<span style="color:var(--txt3)">-</span>')+'</td>'):'';
