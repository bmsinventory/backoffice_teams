...
window.renderProjects=function(){
  ...
  tb.innerHTML=rows.map(function(p){
    ...
    var _revDone=false;
    if(showRevisit){var _revKids=(window.PROJECTS||[]).filter(function(rp){return rp.groupId==='GRP17733355541904'&&rp.parentProjectId===p.id;});_revDone=_revKids.some(function(rp){return rp.revisitRound==99;})||!!(p.revisit1&&p.revisit2);}
